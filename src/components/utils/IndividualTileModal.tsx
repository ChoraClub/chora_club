...
function IndividualTileModal({ title, description, videoUrl, date, host, attendee, dao, onClose }: IndividualTileModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div ref={modalRef} className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full" style={{ maxWidth: "calc(80% + 50px)", maxHeight: "calc(80% + 50px)" }}>
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div className="sm:flex sm:items-start">
              <div className="sm:w-3/5 mx-auto flex items-center justify-center bg-blue-100 rounded-lg">
                  <video controls className="h-full w-full" src="https://huddle01.s3.amazonaws.com/recording/jsv-xzam-tnw/1704174878002.mp4">
            ...
            <div className="pt-5">
              <div className="text-sm text-gray-700 font-semibold mb-2 mt-2" style={{fontSize:"1.5rem"}}>Details:</div>
