...
function UpcomingDaoOfficeHours({ params }: { params: string }) {
  const details = [
    {
      img: text1,
      ...
      host: "lindaxie.eth",
      started: "10/09/2023 11:30 PM EST",
    ...
    },
    {
      ...
      attendee: "olimpio.eth",
      host: "l2beatcom.eth",
      started: "11/09/2023 12:30 PM EST",
...
export default UpcomingDaoOfficeHours;
