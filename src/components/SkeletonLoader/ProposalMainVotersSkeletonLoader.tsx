...
const ProposalMainVotersSkeletonLoader = () => {
 ...
 <div className={`flex flex-col gap-2 py-3 pl-3 pr-2  my-3 border-gray-200 h-[440px] `}>
<div className="animate-pulse max-h-[450px] flex flex-col gap-2 overflow-hidden ">
    {[...Array(4)].map((_, index) => (
      <div className="flex items-center py-6 px-6 bg-white rounded-2xl  border-2 border-transparent space-x-6 gap-4" key={index}>
        ...
        <div className="flex items-center space-x-4">
          <div className="w-36 h-8 bg-gray-200 rounded-full"></div>
