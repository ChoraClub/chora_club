    ...
    {showTooltip && (
      ...
      className="absolute z-10 w-72 p-4 mt-2 bg-white rounded-lg shadow-xl border border-gray-200 transition-all duration-300 ease-in-out transform opacity-100 scale-100">
        <div className="text-sm">
            <h3 className="font-semibold text-lg mb-2 text-gray-800">Rewards Balance</h3>
            <p className="text-2xl font-bold text-blue-600 mb-1">{formattedBalance} ETH</p>
            ...
            {balance > 0 ? (
              ...
              <div>
                <p className="font-semibold text-gray-700 mb-2">Earn rewards by:</p>
