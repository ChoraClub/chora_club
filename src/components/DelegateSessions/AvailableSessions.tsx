    ...
    if (isConnected) {
      router.push(
        ...
        if (openConnectModal) {
          ...
          alert("Wallet connection is not available. Please check your wallet configuration.");
        }
      }
  };
              ...
              >
                ...
                <div className="flex items-center px-3 sm:px-5 pb-2 sm:pb-3">
                  ...
                  <div className="w-[40%] flex justify-end ">
                    <button
                      onClick={() => handleBookSession(daos.session.dao_name, daos.session.userAddress)}
